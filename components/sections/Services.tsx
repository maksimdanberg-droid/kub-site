...
const SERVICES = [
  ...
  },
  {
    ...
    description: "Сопровождаем заявок в различные фонды поддержки. Поможем вернуть до 100% затрат на R&D.",
  },
  {
    icon: Percent,
  ...
  },
  {
    ...
    description: "Регистрируем изобретения и програмное обеспечение",
  },
  {
    icon: FileCheck,
