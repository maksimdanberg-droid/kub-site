        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-gray-600 leading-relaxed">
              ООО «КУБ» — консалтинг для технологических компаний. Мы не продаём воздух: строим финансовую и правовую защиту ваших разработок. Смета утверждается до заключения договора: в неё входит подготовка проекта, подача, настройка учётной политик. Все изменения согласовываем письменно до выполнения работ.
            </motion.p>
            
            <motion.p variants={fadeInUp} className="text-gray-600 leading-relaxed">
              В штате 12 профильных специалистов: профильные аналитики, патентные поверенные, юристы по госрегулированию, технический писатель. Мы не передаём материалы на аутсорс и не меняем специалистов без вашего согласования. С первого дня предоставляем доступ к личному кабинету с трекингом этапов, сроками и версиями документов.
            </motion.p>
