...
export default function CasesDeburringMachine() {
  return (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              Металлообработка → Станок для снятия заусенцев, грата и окалины
            </motion.h2>
            ...
            >
              <p className="text-gray-700 leading-relaxed">
                <span className="font-semibold text-kub-navy">Задача:</span> Получить грант на разработку отечественного станка для зачистки кромок металлических деталей после лазерной и плазменной резки.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="list-none space-y-3">
                {[
                  "Провели аудит проекта и подобрали конкурс под стадию готовности разработки",
                  "Выполнили патентный поиск и обосновали новизну конструкторских решений",
                  "Подготовили техническую документацию: ТЗ, календарный план, смету и состав работ",
                  "Разработали экономический блок с анализом рынка и сравнением с зарубежными аналогами"
                ].map((item, i) => (
            ...
            >
              {[
                { value: "[30 млн ₽]", label: "Грант ФСИ «Старт-1»" },
                { value: "Патент", label: "На полезную модель" },
                { value: "[12 мес]", label: "Срок реализации" }
              ].map((item, i) => (
                <motion.div 
                  key={i} 
                  variants={fadeInUp}
              ...
              <table className="w-full text-sm bg-white rounded-xl border border-gray-100 overflow-hidden">
                ...
                <tbody className="text-gray-700">
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4">Источник оборудования</td>
                    <td className="py-3 px-4">Импорт (ЕС/Китай)</td>
                    <td className="py-3 px-4 font-bold text-kub-gold">Отечественное производство</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4">Защита интеллектуальной собственности</td>
                    <td className="py-3 px-4">Отсутствует</td>
                    <td className="py-3 px-4 font-bold text-kub-gold">Патент на полезную модель</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Зависимость от зарубежных поставщиков</td>
                    <td className="py-3 px-4">Высокая</td>
                    <td className="py-3 px-4 font-bold text-kub-gold">Минимизирована</td>
                  </tr>
                </tbody>
              </table>
            </motion.div>
            ...
            >
              «Благодаря «КУБ» мы получили грант без доработок и уже запустили опытный образец станка. Документация была подготовлена точно под требования фонда».
              <footer className="text-sm text-gray-400 mt-3 not-italic">
                — Главный инженер, Предприятие металлообработки
              </footer>
            </motion.blockquote>
            ...
            >
              С-З ФО / Металлообработка / ФСИ «Старт-1»
            </motion.p>
